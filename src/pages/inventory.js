...
function Inventory() {
    ...
    return (
        ...
        //       <MDBCard>
        //             <MDBCardBody id='products'>
        //              <MDBCardTitle className='cardText'>{product.name}</MDBCardTitle>
        //             <MDBCardText className='cardText'>Price: {product.price}</MDBCardText>
        //             <MDBCardText className='cardText'>Stock: {product.stock}</MDBCardText>
        //             <MDBCardText className='cardText'>Sold: {product.sold}</MDBCardText>
        //             <MDBCardText className='cardText'>Revenue: {product.revenue}</MDBCardText>
